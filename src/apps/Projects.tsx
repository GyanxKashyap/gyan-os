        ...
        <div className="grid grid-cols-2 gap-3">
          {list.map((p) => (
            <button
              key={p.id}
              onClick={() => setSel(p)}
              className="flex flex-col rounded-2xl border border-black/8 bg-white/50 p-4 text-left transition-all hover:-translate-y-0.5 hover:bg-white/75 hover:shadow-[0_8px_24px_-8px_rgba(40,25,70,0.25)]"
            >
